...
def visualize_history_data(dataset: List[dict]):
    ...
    line: Line = (Line(init_opts=opts.InitOpts(theme=ThemeType.CHALK, page_title="历史空气数据"))
        ...
        .add_yaxis("AQI指数", aqi_series, is_connect_nones=True, is_selected=False)
        .add_yaxis("Pm2.5浓度", pm25_series, is_connect_nones=True)
        .add_yaxis("Pm10浓度", pm10_series, is_connect_nones=True, is_selected=False)
        .add_yaxis("O3浓度", o3_series, is_connect_nones=True, is_selected=False)
        .add_yaxis("NO2浓度", no2_series, is_connect_nones=True, is_selected=False)
        .add_yaxis("SO2浓度", so2_series, is_connect_nones=True, is_selected=False)
        .add_yaxis("CO浓度", co_series, is_connect_nones=True, is_selected=False)
